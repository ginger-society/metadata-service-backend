...
#[derive(Debug)]
pub struct NotificationService_config(pub Configuration); // Wrapper struct for Configuration

#[rocket::async_trait]
impl<'r> FromRequest<'r> for NotificationService_config {
    type Error = ();
    ...
    async fn from_request(request: &'r Request<'_>) -> Outcome<Self, Self::Error> {
        ...
        Outcome::Success(NotificationService_config(configuration))
    }
}

impl<'a> OpenApiFromRequest<'a> for NotificationService_config {
